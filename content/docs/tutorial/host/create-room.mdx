...
Berikut adalah alur lengkap mengenai sistem **Create Room** di Zigma berdasarkan modul client dan server:
...
**Modul:** Antarmuka Pengaturan Kuis Host
...
```typescript title="Alur Pembuatan Room di Sisi Client"
const options = {
...
**Modul:** Penanganan Otomatis URL Kompetisi
...
```typescript title="Fungsi Auto-Create dari URL Parameter"
...
```typescript title="Inisialisasi GameRoom Sisi Server"
...
**Modul:** Setup Metadata & Sub-Rooms
...
```typescript title="Setup Metadata & Simpan Sesi Database"
